...
const values = {
  ...
  NEXT_PUBLIC_KAKAO_JAVASCRIPT_KEY: sourceEnv.NEXT_PUBLIC_KAKAO_JAVASCRIPT_KEY || sourceEnv.KAKAO_JAVASCRIPT_KEY || currentTarget.NEXT_PUBLIC_KAKAO_JAVASCRIPT_KEY || currentTarget.KAKAO_JAVASCRIPT_KEY || "",
